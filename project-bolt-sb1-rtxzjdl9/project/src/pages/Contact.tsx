...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-red">
      {/* Hero Section */}
      <section className="py-24 bg-gradient-to-br from-blue-100 via-gray to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              We’d love to hear from you. Reach out to explore how our innovative tech solutions can help your business thrive.
            </motion.p>
          </div>
        </div>
      </section>
