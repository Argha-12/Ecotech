        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Explore exciting career opportunities with Ecotech Global Services. 
              We're always looking for talented individuals to join our growing team.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center">
                  <span className="text-white text-xl">💻</span>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-white">Senior Cybersecurity Analyst</h3>
                  <p className="text-gray-400 text-sm">Full-time • Remote</p>
                </div>
              </div>
              <p className="text-gray-300 mb-4">Lead security initiatives and protect our clients from evolving cyber threats.</p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-blue-500/20 text-blue-300 rounded-full text-xs font-semibold">Security</span>
                <span className="px-3 py-1 bg-indigo-500/20 text-indigo-300 rounded-full text-xs font-semibold">Analysis</span>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Full-time • Hybrid</p>
                </div>
              </div>
              <p className="text-gray-300 mb-4">Create intuitive and beautiful user experiences for our security platforms.</p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-purple-500/20 text-purple-300 rounded-full text-xs font-semibold">Design</span>
                <span className="px-3 py-1 bg-pink-500/20 text-pink-300 rounded-full text-xs font-semibold">UX</span>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-300 mb-4">Build and maintain scalable infrastructure for our cybersecurity solutions.</p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-emerald-500/20 text-emerald-300 rounded-full text-xs font-semibold">DevOps</span>
                <span className="px-3 py-1 bg-teal-500/20 text-teal-300 rounded-full text-xs font-semibold">Cloud</span>
              </div>
            </div>
          </div>
        </div>
